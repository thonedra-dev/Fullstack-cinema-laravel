{{--
    ...
    ─────────────────────────────────────────────────────────
    Branch Manager dashboard — 4 portals.
    Controller: BranchManagerDashboardController@home
    Data injected (logic-free blade):
      $cinema – Cinema model with ->city (for header display)
--}}
...
<div class="bm-page-header">
    <h1 class="bm-page-header__title">
...
<div class="bm-portal-grid">
    ...
    <a href="{{ route('manager.cinema.profile') }}" class="bm-portal-card">
        ...
        <div class="bm-portal-card__body">
            ...
            <p class="bm-portal-card__desc">View and review cinema details, contact, and location.</p>
        </div>
    ...
    <a href="{{ route('manager.resources') }}" class="bm-portal-card">
        ...
        <div class="bm-portal-card__body">
            ...
            <p class="bm-portal-card__desc">Browse theatres and movies assigned to this cinema.</p>
        </div>
        <span class="bm-portal-card__arrow">→</span>
    </a>

    {{-- Portal 3: Notifications (static) --}}
...
<style>
/* Portal grid — scoped here to avoid polluting branch_manager.css */
.bm-portal-grid {
    display: grid;
