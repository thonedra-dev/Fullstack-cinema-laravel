...
@section('head_extras')
    @vite([
        'resources/css/movie-live/_layout.css',
        'resources/css/movie-live/_components.css',
        'resources/css/movie-live/_finance.css',
        'resources/css/movie-live/_seats.css',
...
<div id="mldRoot" class="mld-app" 
     ...
     data-cinemas-financials-url-template="{{ route('admin.movies.now_showing.cinemas_financials', ['movie' => $movie->movie_id]) }}"
     data-theatres-financials-url-template="{{ route('admin.movies.now_showing.theatres_financials', ['movie' => $movie->movie_id, 'cinema' => '__CINEMA_ID__']) }}"
     data-movies-financials-url-template="{{ route('admin.movies.now_showing.movies_financials', ['movie' => $movie->movie_id, 'cinema' => '__CINEMA_ID__', 'theatre' => '__THEATRE_ID__']) }}"
     data-showtimes-financials-url-template="{{ route('admin.movies.now_showing.showtimes_financials', ['movie' => $movie->movie_id, 'cinema' => '__CINEMA_ID__', 'theatre' => '__THEATRE_ID__']) }}"
>

    {{-- HEADER (fixed, no scroll) --}}
    <div class="mld-app-header">
        <div class="ac-page-header mp-header" style="margin-bottom:0;">
            <div>
